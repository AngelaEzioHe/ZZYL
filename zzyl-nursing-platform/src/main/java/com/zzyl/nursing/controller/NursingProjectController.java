...
public class NursingProjectController extends BaseController
{
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam(name = "nursingProject", value = "查询条件对象", required = true, dataType = "NursingProjet", paramType = "query"),
    })
	...
	@DeleteMapping("/{ids}")
    public AjaxResult remove(@PathVariable @ApiParam("删除护理项目对象") Long[] ids)
    {
