...
public class QianfanAIModelTest {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        OpenAIClient  client = OpenAIOkHttpClient.builder()
                .apiKey("bce-v3/ALTAK-OwKFChKgxtezj4Gpp7WLr/4972336e6b978fdfa24d1eeda8079013b81b4f6c") //将your_APIKey替换为真实值，如何获取API Key请查看https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Um2wxbaps#步骤二-获取api-key
